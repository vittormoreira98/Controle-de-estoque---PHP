...
<?php
	...
	$sqlteste = "SELECT * FROM fabricante WHERE id = '$idmodificar'";
	$qryteste = mysql_query($sqlteste, $base);
	$existe_reg = mysql_num_rows($qryteste);
	if ($existe_reg < 1){
		echo "<script>alert('Este FABRICANTE de produto não existe!');location.href = 'criatipo.php';</script>";
		exit;
	}	
	$sql = "SELECT * FROM fabricante WHERE id = '$idmodificar'";
          ...
          <tr> 
            <td height="307" colspan="3" align="center" valign="top"> <div align="center"> 
              <table width="560" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td colspan="3"><img src="imagens/fabricante.gif"></td>
  </tr>
  <tr> 
    <td width="58">&nbsp;</td>
    <td width="412" rowspan="4"><div align="center">
<p class="font1"><br><br>Alterar Tipo</p>
        <form name="form1" method="post" action="fabricantemuda.php">
          <font class="font1">Fabricante : </font> 
