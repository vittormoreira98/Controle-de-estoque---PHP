...
<script>function checar(pagina,texto) { if (confirm("DELETAR ESTE TIPO DE PRODUTO ?")==true) { window.location=pagina; } }</script>
<style type="text/css">
<!--
body {
text-align:center;
          ...
          <tr> 
            <td height="307" colspan="3" valign="top"><div align="center">
                <table width="560" height="97" border="0" cellpadding="0" cellspacing="0">
                  <tr> 
                    <td height="19" valign="top"><img src="imagens/criatipo.gif"></td>
  </tr>
  <tr> 
    <td height="53"> <div align="center"> 
        <form name="form1" method="post" action="incluirtipo.php">
          <p>&nbsp;</p>
          <p><font class="font1">Tipo :</font> 
  ...
  <tr> 
	...
	?>
      <div align="center"> 
            ...
            <?php
			if ($totalreg < 1){
			echo "<tr><td width=\"440\"><div align=\"center\"><font class=\"font1\"><i><br><br>Nenhum <u>Tipo de Produto</u> cadastrado!</i></font></div></td></tr>";
			} else {
	...
	?>
           ...
           <tr id="teste" onMouseOver="this.style.backgroundColor='#C1FFC1'" onMouseOut="this.style.backgroundColor='<?=($i % 2 == 0 ? "#F7F7F7" : "#E6E6E6")?>'" bgcolor="<?=($i % 2 == 0 ? "#F7F7F7" : "#E6E6E6")?>"> 
            ...
            <td width="36"><div align="center"><a href="altertipo.php?id=<?= $reg['id'] ?>"><img src="imagens/atualizar.jpg" border="0" alt="Alterar"></a></div></td>
            <td width="36"><div align="center"><a href="javascript:checar('deltipo.php?id=<?= $reg['id'] ?>');"><img src="imagens/delete.gif" border="0" alt="Deletar"></a></div></td>
          </tr>
          <?php
	$i++;
		}
